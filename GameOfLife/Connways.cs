...
namespace GameOfLife
{
    public class Connways
	{
        ...
        public int searchneighbour(int x, int y, int [,] currentboard)
        {
			...
			if (x > 0 & y < currentboard.GetLength(0)-1 && currentboard[xmin, ymax] == 1) ///bottom left
                counter += 1;

            if (y > 0 && currentboard[x, ymin] == 1) ///top mid
                counter += 1;

			if (y < currentboard.GetLength(0)-1 && currentboard[x, ymax] == 1) ///bottom mid
                counter += 1;

			if (x < currentboard.GetLength(0)-1 & y > 0 && currentboard[xmax, ymin] == 1) ///top right
                counter += 1;

			if (x < currentboard.GetLength(0)-1 && currentboard[xmax, y] == 1) ///middle right
                counter += 1;

			if (x < currentboard.GetLength(0)-1 & y < currentboard.GetLength(0)-1 && currentboard[xmax, ymax] == 1) ///bottom right
                counter += 1;
